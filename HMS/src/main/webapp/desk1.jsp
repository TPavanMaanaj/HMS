...
<body>
<div style="text-align:center; padding-left:20px;"><h1 style="text-align:center;">Destinations</h1>
...
<img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQsMLJkLiQ-68RorOeIArowF4lYp-zzBbpqwQ&s" alt="Destination 1">           
	            ...
	            <a href="DestinationServlet?hotelName=Paris" class="book-btn">Check Details</a>
        </div>
